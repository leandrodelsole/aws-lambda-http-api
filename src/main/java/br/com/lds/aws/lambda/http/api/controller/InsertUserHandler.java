...
import br.com.lds.aws.lambda.http.api.controller.InsertUserHandler.Empty;
...
public class InsertUserHandler implements RequestHandler<UserRequest, Empty> {

	public Empty handleRequest(UserRequest userRequest, Context context) {
